...
<asp:Content ContentPlaceHolderID="content" runat="server">
    ...
    <div class="circlesGroup">
        ...
        <span id="visitas" class="circle shadow-drop-2-center " onclick="location='/pages/Visitas.aspx'">
        ...
        <span id="caixa" class="circle shadow-drop-2-center " onclick="location='/pages/Caixa.aspx'">
